...
pub fn string_lib<'gc>(ctx: Context<'gc>) -> Table<'gc> {
    ...
    t.set(
        ...
        Callback::from_fn(&ctx, |s: Str<'gc>, i: usize| {
            s.chars().nth(i).map(|x| x.to_smolstr())
        }),
    );
    t.set(
        ctx,
    ...
    t.set(
        ctx,
        "trim",
        Callback::from_fn(&ctx, |s: Str<'gc>| s.trim().to_smolstr()),
    );
    t.set(
        ctx,
        "trim_start",
        Callback::from_fn(&ctx, |s: Str<'gc>| s.trim_start().to_smolstr()),
    );
    t.set(
        ctx,
        "trim_end",
        Callback::from_fn(&ctx, |s: Str<'gc>| s.trim_end().to_smolstr()),
    );
    t.set(
        ctx,
        "strip_prefix",
        Callback::from_fn(&ctx, |s1: Str<'gc>, s2: Str<'gc>| {
            s1.strip_prefix(s2.as_ref()).map(|x| x.to_smolstr())
        }),
    );
    t.set(
        ctx,
        "strip_suffix",
        Callback::from_fn(&ctx, |s1: Str<'gc>, s2: Str<'gc>| {
            s1.strip_suffix(s2.as_ref()).map(|x| x.to_smolstr())
        }),
    );
    t.set(
        ctx,
    ...
    t.set(
        ...
        Callback::from_fn(
            ...
            |s: Str<'gc>, from: Str<'gc>, to: Str<'gc>, count: usize| {
                s.replacen_smolstr(from.as_ref(), to.as_ref(), count)
            },
        ),
    );
    t.set(
        ctx,
        "to_lowercase",
        Callback::from_fn(&ctx, |s: Str<'gc>| s.to_lowercase_smolstr()),
    );
    t.set(
        ctx,
        "to_uppercase",
        Callback::from_fn(&ctx, |s: Str<'gc>| s.to_uppercase_smolstr()),
    );
    t.set(
        ctx,
        "to_ascii_lowercase",
        Callback::from_fn(&ctx, |s: Str<'gc>| s.to_ascii_lowercase_smolstr()),
    );
    t.set(
        ctx,
        "to_ascii_uppercase",
        Callback::from_fn(&ctx, |s: Str<'gc>| s.to_ascii_uppercase_smolstr()),
    );
    t.set(
        ctx,
        "repeat",
        Callback::from_fn(&ctx, |s: Str<'gc>, i: usize| s.repeat(i).to_smolstr()),
    );
    t
}
